...
public class HandTrackingBootStrap : MonoBehaviour
{
    ...
    private void DetectHandTracking(dynamic handState){
         if (handState.isTracked)
            {
                ...
                tipAnchor.gameObject.SetActive(true);
            }
            else
            {
    ...
    private void UpdateAnchorTransform(Vector3 jointPos)
    {
            ...
            tipAnchor.position = jointPos + Vector3.up * 0.01f - vec_horizontal * 0.015f;
